...
class PatternWorkOrderManager:
    def __init__(self, parent, pattern_work_order_form, config):
        ...
        self.pattern_work_order = PWO.PatternWorkOrder(config)
...
##        workbook = load_workbook(self.config.get_engineering_log_book_file())
##        sheet = workbook.active
##        row = sheet.max_row + 1
##
...
##
##        workbook.save(self.config.get_engineering_log_book_file())
...
##            print(f"Could not find Jira issue with summary '{issue_summary}' in project '{project_key}'.")
    ...
    def create_pattern_work_order(self):
        user_inputs = self.pattern_work_order_form.get_user_inputs()
        self.pattern_work_order.update_pattern_work_order_fields(user_inputs)

        self.pattern_work_order.update_log_book()
        word_file_path = self.pattern_work_order.generate_word_file()
        self.pattern_work_order.generate_pdf_file(word_file_path)
        self.pattern_work_order.send_email()
        #self.pattern_work_order.attach_pattern_work_order_to_jira_issue()
