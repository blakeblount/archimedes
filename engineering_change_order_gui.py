...
from engineering_change_order_manager import EngineeringChangeOrderManager

class EngineeringChangeOrderForm:
    def __init__(self, parent, organize_engineering_change_order_callback, print_engineering_change_order_callback):
        self.top = tk.Toplevel(parent)
        self.top.title("Engineering Change Order Form")
        ...
        # Assign callbacks
        self.organize_engineering_change_order_callback = organize_engineering_change_order_callback
        self.print_engineering_change_order_callback = print_engineering_change_order_callback
    ...
    def create_widgets(self): 
        ...
        ttk.Label(self.top, text="Part Number:").grid(row=0, column=0, sticky="w", padx=5, pady=5)
        self.part_number_var = tk.StringVar()
        self.part_number_field = ttk.Entry(self.top, textvariable=self.part_number_var)
        self.part_number_field.grid(row=0, column=1, sticky="w", padx=5, pady=5)
        self.part_number_field.focus_set()
        self.part_number_field.bind('<Return>', self.organize_engineering_change_order_callback)

        # Create Organize button
        self.organize_button = ttk.Button(self.top, text="Organize ECO", command=self.organize_engineering_change_order_callback)
        self.organize_button.grid(row=1, column=0, padx=5, pady=5, sticky="ew")
        self.organize_button.bind('<Return>', self.organize_engineering_change_order_callback)
        ...
        # Create Print button
        self.print_button = ttk.Button(self.top, text="Print ECO", command=self.print_engineering_change_order_callback, state=tk.DISABLED)
        self.print_button.grid(row=2, column=0, padx=5, pady=5, sticky="ew")
        self.print_button.bind('<Return>', self.print_engineering_change_order_callback)
    ...
    def display_engineering_change_order_data(self, engineering_change_order_data_table, compression_list, comp_code_chart):
        ...
        headers = ["CO Number", "Part Number", "Line Item(s)", "Quantity", "Intl/OEM", "Due Date"]
        ...
        self.toggle_print_button = ttk.Button(self.scrollable_frame, text='Select', command=self.toggle_print_checkboxes)
        ...
        # Populate data table
        for i, row in enumerate(engineering_change_order_data_table):
    ...
    def get_part_number(self):
        return self.part_number_var.get()
